...
```limn
wrl apr @ mac*com | cld^0.9 dar^0.5 | lif^0
```
...
```limn
mes say : Magrathea end wrk | wrl slp dur fiv mil yea
```
...
```limn
mes say : awa we | des cus wrl te | wai mus
```
