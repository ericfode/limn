...
```limn
Marvin : bra big as wrl | req tak | frs^0.99
```

- `bra big as wrl` = brain big as planet
...
```limn
Arthur see out | sun al | wrl : nu
```

- `sun al` = suns everywhere (stars)
- `wrl : nu` = planet: negated. Gone.
